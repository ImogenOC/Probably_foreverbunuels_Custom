...
ProbablyEngine.rotation.register_custom(261, "foreverbunuel's Custom", {
  ...
  function ()
  ProbablyEngine.toggle.create('hem', 'Interface\\Icons\\spell_shadow_lifedrain', 'Enables use of Hemmorhage if we cannot do anything else.', '')
  ProbablyEngine.toggle.create('as', 'Interface\\Icons\\ability_rogue_kidneyshot', 'Enables use of Alternate Silences.', '')
  ProbablyEngine.toggle.create('sap', 'Interface\\Icons\\ability_rogue_blackjack', 'Enables use of Sap while stealthed.', '')
  ProbablyEngine.toggle.create('buff', 'Interface\\Icons\\ability_rogue_slicedice', 'Enables use of various buffs.', '')
  ProbablyEngine.toggle.create('rup', 'Interface\\Icons\\ability_rogue_rupture', 'Enables use of Rupture', '')
  end
  )